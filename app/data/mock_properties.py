"""
Datos Mock de Propiedades para PropChat
========================================
120+ propiedades distribuidas en todo Perú

Incluye:
- 20 propiedades cerca de campus UTP (Lima Centro, Norte, SJL, VES, Ate)
- Propiedades en los 25 departamentos del Perú
- Tipos: apartments y houses
- Transacciones: rent y sale
"""

MOCK_PROPERTIES = [
    # === PROPIEDADES CERCA DE UTP (20 propiedades, 4 por campus) ===

    # --- CERCA DE UTP LIMA CENTRO (Cercado de Lima) - 4 propiedades ---
    {
        "id": "utp1", "title": "Depa económico cerca de UTP Centro", "price": 650, "bedrooms": 2, "bathrooms": 1, "area": 55,
        "district": "Cercado de Lima", "latitude": -12.0470, "longitude": -77.0435,
        "imageUrl": "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Departamento amoblado a 2 cuadras de UTP Lima Centro. Ideal para estudiantes."
    },
    {
        "id": "utp2", "title": "Habitación con baño privado - UTP Centro", "price": 400, "bedrooms": 1, "bathrooms": 1, "area": 25,
        "district": "Cercado de Lima", "latitude": -12.0458, "longitude": -77.0422,
        "imageUrl": "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Habitación independiente cerca de UTP. Wifi, luz y agua incluidos."
    },
    {
        "id": "utp3", "title": "Depa 3 dorm. para compartir - UTP Centro", "price": 900, "bedrooms": 3, "bathrooms": 2, "area": 80,
        "district": "Cercado de Lima", "latitude": -12.0472, "longitude": -77.0440,
        "imageUrl": "https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Perfecto para compartir con compañeros de UTP. A 5 min caminando."
    },
    {
        "id": "utp4", "title": "Mini depa amoblado UTP Centro", "price": 550, "bedrooms": 1, "bathrooms": 1, "area": 35,
        "district": "Cercado de Lima", "latitude": -12.0466, "longitude": -77.0430,
        "imageUrl": "https://images.unsplash.com/photo-1540518614846-7eded433c457?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Totalmente amoblado y equipado. Vista a la calle principal."
    },

    # --- CERCA DE UTP LIMA NORTE (Los Olivos) - 4 propiedades ---
    {
        "id": "utp5", "title": "Depa moderno cerca UTP Lima Norte", "price": 700, "bedrooms": 2, "bathrooms": 1, "area": 60,
        "district": "Los Olivos", "latitude": -11.9805, "longitude": -77.0575,
        "imageUrl": "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Departamento nuevo a 3 cuadras de UTP Lima Norte. Seguridad 24/7."
    },
    {
        "id": "utp6", "title": "Casa 3 pisos cerca UTP Norte", "price": 1200, "bedrooms": 4, "bathrooms": 3, "area": 140,
        "district": "Los Olivos", "latitude": -11.9795, "longitude": -77.0585,
        ...
        "description": "Casa amplia para grupo de estudiantes. Cochera para 2 autos."
    },
    {
        "id": "utp7", "title": "Depa con piscina UTP Norte", "price": 850, "bedrooms": 2, "bathrooms": 2, "area": 70,
        "district": "Los Olivos", "latitude": -11.9808, "longitude": -77.0590,
        "imageUrl": "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Edificio con piscina y gimnasio. Frente al Megaplaza."
    },
    {
        "id": "utp8", "title": "Habitación para estudiante UTP Norte", "price": 350, "bedrooms": 1, "bathrooms": 1, "area": 20,
        "district": "Los Olivos", "latitude": -11.9798, "longitude": -77.0578,
        "imageUrl": "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Habitación en casa familiar. Ambiente tranquilo para estudiar."
    },

    # --- CERCA DE UTP SJL (San Juan de Lurigancho) - 4 propiedades ---
    {
        "id": "utp9", "title": "Depa económico cerca UTP SJL", "price": 600, "bedrooms": 2, "bathrooms": 1, "area": 50,
        "district": "San Juan de Lurigancho", "latitude": -11.9880, "longitude": -77.0055,
        "imageUrl": "https://images.unsplash.com/photo-1540518614846-7eded433c457?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "A pasos de UTP SJL. Cerca de paraderos y comercios."
    },
    {
        "id": "utp10", "title": "Casa grande para compartir UTP SJL", "price": 1000, "bedrooms": 3, "bathrooms": 2, "area": 100,
        "district": "San Juan de Lurigancho", "latitude": -11.9870, "longitude": -77.0062,
        "imageUrl": "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400",
        "type": "house", "department": "LIMA", "transaction_type": "rent",
        "description": "Casa espaciosa ideal para grupo de amigos de UTP."
    },
    {
        "id": "utp11", "title": "Mini depa amoblado UTP SJL", "price": 500, "bedrooms": 1, "bathrooms": 1, "area": 30,
        "district": "San Juan de Lurigancho", "latitude": -11.9882, "longitude": -77.0050,
        "imageUrl": "https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Completamente amoblado. Internet de alta velocidad."
    },
    {
        "id": "utp12", "title": "Depa 2 dorm. cerca UTP SJL", "price": 750, "bedrooms": 2, "bathrooms": 1, "area": 65,
        "district": "San Juan de Lurigancho", "latitude": -11.9873, "longitude": -77.0058,
        "imageUrl": "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Departamento nuevo con acabados modernos. Vista panorámica."
    },

    # --- CERCA DE UTP VILLA EL SALVADOR - 4 propiedades ---
    {
        "id": "utp13", "title": "Depa económico cerca UTP VES", "price": 550, "bedrooms": 2, "bathrooms": 1, "area": 48,
        "district": "Villa El Salvador", "latitude": -12.2120, "longitude": -76.9370,
        "imageUrl": "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Cerca de UTP VES. Zona tranquila y segura."
    },
    {
        "id": "utp14", "title": "Casa para estudiantes UTP VES", "price": 950, "bedrooms": 3, "bathrooms": 2, "area": 90,
        "district": "Villa El Salvador", "latitude": -12.2112, "longitude": -76.9358,
        "imageUrl": "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400",
        "type": "house", "department": "LIMA", "transaction_type": "rent",
        "description": "Casa amplia con patio. Ideal para compartir."
    },
    {
        "id": "utp15", "title": "Habitación privada cerca UTP VES", "price": 300, "bedrooms": 1, "bathrooms": 1, "area": 18,
        "district": "Villa El Salvador", "latitude": -12.2118, "longitude": -76.9366,
        "imageUrl": "https://images.unsplash.com/photo-1540518614846-7eded433c457?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Habitación con baño. Servicios incluidos."
    },
    {
        "id": "utp16", "title": "Depa nuevo cerca UTP VES", "price": 700, "bedrooms": 2, "bathrooms": 1, "area": 60,
        "district": "Villa El Salvador", "latitude": -12.2114, "longitude": -76.9362,
        "imageUrl": "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Departamento recién construido. A 5 minutos de UTP."
    },

    # --- CERCA DE UTP ATE - 4 propiedades ---
    {
        "id": "utp17", "title": "Depa moderno cerca UTP Ate", "price": 680, "bedrooms": 2, "bathrooms": 1, "area": 58,
        "district": "Ate", "latitude": -12.0265, "longitude": -76.8975,
        "imageUrl": "https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Cerca de UTP Ate y Megaplaza. Excelente ubicación."
    },
    {
        "id": "utp18", "title": "Casa con jardín UTP Ate", "price": 1100, "bedrooms": 3, "bathrooms": 2, "area": 110,
        "district": "Ate", "latitude": -12.0258, "longitude": -76.8968,
        "imageUrl": "https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=400",
        "type": "house", "department": "LIMA", "transaction_type": "rent",
        "description": "Casa con jardín y cochera. Perfecta para familias o grupos."
    },
    {
        "id": "utp19", "title": "Mini depa UTP Ate", "price": 520, "bedrooms": 1, "bathrooms": 1, "area": 32,
        "district": "Ate", "latitude": -12.0268, "longitude": -76.8978,
        "imageUrl": "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Compacto y funcional. A pasos de UTP Ate."
    },
    {
        "id": "utp20", "title": "Depa 2 dorm. amoblado UTP Ate", "price": 800, "bedrooms": 2, "bathrooms": 2, "area": 70,
        "district": "Ate", "latitude": -12.0260, "longitude": -76.8973,
        "imageUrl": "https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=400",
        "type": "apartment", "department": "LIMA", "transaction_type": "rent",
        "description": "Totalmente amoblado y equipado. Zona comercial."
    },

    # --- LIMA (5 propiedades adicionales) ---
    {
